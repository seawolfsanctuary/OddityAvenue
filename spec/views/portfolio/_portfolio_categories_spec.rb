...
describe 'portfolio/_portfolio_categories' do
  ...
  context "with PortfolioItem categories" do
    ...
    it "should create a new list item for each category where enabled items exist" do
      render
      rendered.should be_include("<li>" + link_to("cat 1", portfolio_item_category_path("cat 1"))  + "</li>")
      rendered.should be_include("<li>" + link_to("cat 2", portfolio_item_category_path("cat 2"))  + "</li>")
    end
